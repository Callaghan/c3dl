...
"		{" +
"			if(appliedLight == false && lights[0].isOn == true)" +
"			{" +
"				if(lights[0].type == 1)" +
"				{" +
"					c3dl_goochDirLight(lights[0], nviewVec, ntnorm, NdotL, spec); "+
"					appliedLight = true;" +
"				}" +
"				else" +
"				{" +
"					c3dl_goochPointLight(lights[0], nviewVec, ntnorm, NdotL, spec); "+
"					appliedLight = true;" +
"				}" +
"			}" +
"		}"+
